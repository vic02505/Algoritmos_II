...
typedef enum {
    ObtenerEstadisticas, //ok ok.

    AtenderProximoEntrenador, //ok ok.

    ObtenerInformacionPokemonEnTratamiento, //ok.
    AdivinarNivelPokemon, //ok ok. 

    AgregarDificultad, //ok.
    SeleccionarDificultad,//ok ok.
    ObtenerInformacionDificultad, //ok ok.
...
/**
 * Crea un simulador para un hospital. El simulador toma control dObtenerEstadisticas
 */
